package com.team3.baby.module.fragments_groupBuy.url;
...
public class UrlGroupBuy {
    ...
    public static final String ONE = "http://f.m.suning.com/api/pgs/cateView" +
            ".do?version=2&cateId=1002&page=1&size=10";
    ...
    public static final String NINE = "http://f.m.suning.com/api/pgs/cateView" +
            ".do?version=2&cateId=1007&page=1&size=10";
    public static final String TEN = "http://f.m.suning.com/api/pgs/cateView" +
