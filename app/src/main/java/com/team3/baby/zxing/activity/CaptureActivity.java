 ...
 */
package com.team3.baby.zxing.activity;
...
import com.team3.baby.zxing.camera.CameraManager;
import com.team3.baby.zxing.decode.DecodeThread;
import com.team3.baby.zxing.utils.BeepManager;
import com.team3.baby.zxing.utils.CaptureActivityHandler;
import com.team3.baby.zxing.utils.InactivityTimer;

import java.io.IOException;
import java.lang.reflect.Field;

/**
 * This activity opens the camera and does the actual scanning on qrcode_scan_btn_flash_nor
 * background
 * thread. It draws qrcode_scan_btn_flash_nor viewfinder to help the user place the barcode
 * correctly,
 * shows feedback as the image processing is happening, and then overlays the
 * results when qrcode_scan_btn_flash_nor scan is successful.
 *
 * @author dswitkin@google.com (Daniel Switkin)
 * @author Sean Owen
 */
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, View
        .OnClickListener {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        if (holder == null) {
            Log.e(TAG, "*** WARNING *** surfaceCreated() gave us qrcode_scan_btn_flash_nor null " +
                    "surface!");
        }
        if (!isHasSurface) {
            isHasSurface = true;
    ...
    private void cameraFlashControl() {
        ...
        if (cameraManager.flashControlHandler()) {
            cameraFlashControl.setImageResource(R.mipmap.led_lamp_close);

        } else {
            cameraFlashControl.setImageResource(R.mipmap.led_lamp_open);

        }
    }

    private void initView() {
        cameraFlashControl = (ImageView) findViewById(R.id.image_button1);
